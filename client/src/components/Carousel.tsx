...
const CarouselPic: React.FC = () => {
  ...
  return (
    <Carousel afterChange={onChange}>
        <div>
            <h3 style={contentStyle}><img style ={imageStyle} src="https://images.unsplash.com/photo-1489015712802-f490a7a1061d?q=80&w=1472&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Image of Fish" /></h3>
        </div>
        <div>
        ...
        <div>
            <h3 style={contentStyle}><img style ={imageStyle} src="https://www.zoo-berlin.de/fileadmin/_processed_/f/a/csm_Afrikanischer_Loewe_-_Mateo_2__5a177d6871.jpg" alt="Image of Iguana" /></h3>
        </div>
    </Carousel>
  );
};
